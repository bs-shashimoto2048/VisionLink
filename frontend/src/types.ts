...
export interface InternalDataLookupResponse {
  source: string;
  order_no: string;
  serial_no: string;
  terminal_name: string;
  rows: InternalDataRow[];
}
...
export interface InspectionRowState {
  ...
  ocr_text?: string | null;
  manual_final_status?: CheckStatus | null;
  manual_edit_history: ManualEditHistoryEntry[];
  updated_at: string;
}
